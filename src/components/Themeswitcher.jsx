...
function Themeswitcher() {
  ...
  return (
    <div className='flex items-center'>
      <a class="hs-dark-mode-active:hidden block hs-dark-mode group flex items-center text-violet-950 hover:text-purple-800 font-medium dark:text-gray-400 dark:hover:text-gray-500" href="#!" data-hs-theme-click-value="dark">
      ...
      <a class="hs-dark-mode-active:block hidden hs-dark-mode group flex items-center text-gray-600 hover:text-blue-600 font-medium dark:text-gray-100 dark:hover:text-gray-500" href="#!" data-hs-theme-click-value="light">
