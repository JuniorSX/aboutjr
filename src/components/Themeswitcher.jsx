...
function Themeswitcher() {
  ...
  return (
    <div className='flex items-center'>
      <a class="hs-dark-mode-active:hidden block hs-dark-mode group flex items-center text-violet-950 hover:text-purple-800 font-medium dark:text-gray-400 dark:hover:text-gray-500" href="#!" data-hs-theme-click-value="dark" onClick={() => { shirt.toggleTheme(); }}>
      ...
      <a class="hs-dark-mode-active:block hidden hs-dark-mode group flex items-center text-gray-600 hover:text-blue-600 font-medium dark:text-gray-100 dark:hover:text-gray-500" href="#!" data-hs-theme-click-value="light" onClick={() => { shirt.toggleTheme(); }}>
        <svg class="w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
          <g>
            <g>
              <g>
