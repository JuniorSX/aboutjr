...
function Header() {
  ...
  return (
    <header class="sticky top-0 flex  flex-wrap md:flex-nowrap md:justify-start md:flex-col z-50 w-full text-sm pb-4 bg-white h-20 border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
      <div className='flex container max-w-screen-xl px-3 mt-2 mb-2 mr-auto ml-auto justify-between '>
        <div className='hidden md:flex items-center'>
          <a class="mr-2 hs-dark-mode group flex items-center text-gray-700 hover:text-purple-800 font-medium dark:text-gray-400 dark:hover:text-purple-500" href="mailto:souza.jr91@gmail.com" rel="noreferrer">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="3" y="5" width="18" height="14" rx="1" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M20 5.5L12 13L4 5.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <p className='font-semibold text-base ml-1 dark:font-normal'>souza.jr91@gmail.com</p>
          </a>
          <a class=" mr-2 hs-dark-mode group flex items-center text-gray-700 hover:text-purple-800 font-medium dark:text-gray-400 dark:hover:text-purple-500" href="https://wa.me/5551997344246" target='_blank' rel="noreferrer">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='font-semibold text-base ml-2 dark:font-normal'>(51) 9 9734-4246</p>
          </a>
        </div>
        <div className='flex justify-center sm:justify-end w-full md:w-fit '>
          <div class="hs-dropdown relative inline-flex [--placement:top-left] mr-3 z-50">
            <button id="footer-language-dropdown" type="button" class="hs-dropdown-toggle py-1 px-3 inline-flex justify-center items-center gap-2 rounded-md border bg-white text-gray-700 align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-purple-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800">
              <svg class="w-4 h-4 rounded-full" version="1.1" id="flag-icon-css-us" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <circle cx="256" cy="256" r="256" fill="#009541" />
                <path fill="#FFF046" d="M246.207,103.892L28.673,248.915c-5.241,3.495-5.241,11.196,0,14.69l217.534,145.022
	...
	C259.863,99.938,252.137,99.938,246.207,103.892z"/>
                ...
                <path fill="#FFFFFF" d="M165.515,201.127c-3.47,5.709-6.403,11.761-8.758,18.111c49.205-3.345,128.166,5.419,197.503,76.211
	c2.472-6.151,4.404-12.57,5.692-19.229C292.095,211.143,216.738,199.457,165.515,201.127z"/>
            ...
            <div class="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700" aria-labelledby="footer-language-dropdown">
              <a class="flex items-center gap-x-2 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-purple-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="#soon">
          ...
          <div className='flex'>
            <a class=" mr-2  hs-dark-mode group flex items-center text-purple-800 hover:text-violet-950 font-medium dark:text-white dark:hover:text-purple-500" href="https://www.linkedin.com/in/junior-souza/" target='_blank' rel="noreferrer">
              <svg class="w-7 h-7" fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 504.4 504.4" >
            ...
            <a class=" mr-2  hs-dark-mode group flex items-center text-purple-800 hover:text-violet-950  font-medium dark:text-white dark:hover:text-purple-500" href="https://github.com/JuniorSX" target='_blank' rel="noreferrer">
              <svg class="w-8 h-8" fill="currentColor" width="800px" height="800px" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin">
            ...
            <a class=" mr-2  hs-dark-mode group flex items-center text-purple-800 hover:text-violet-950  font-medium dark:text-white dark:hover:text-purple-500" href="https://www.instagram.com/junior_sx/" target='_blank' rel="noreferrer">
              <svg class="w-7 h-7" fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="-271 273 256 256">
	...
	c-3.3,8.1-5.2,17-5.2,26.3c0,38.6,31.4,70,70,70c38.6,0,70-31.4,70-70c0-9.3-1.9-18.2-5.2-26.3H-40V479.5z"/>
      ...
      <nav class="max-w-screen-xl w-full bg-white border border-gray-200 rounded-[36px] mx-auto py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-slate-900 dark:border-gray-700" aria-label="Global">
        <div class="flex items-center justify-between">
          <AnchorLink className="flex items-center" href="#root" aria-label="Junior Souza">
            ...
            <p className='text-xl font-semibold text-purple-800 md:w-96 dark:text-white'>Junior Souza</p>
