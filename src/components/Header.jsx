...
function Header() {
  return (
      ...
      <div className='flex container max-w-screen-xl px-3 mt-2 mb-2 mr-auto ml-auto justify-between'>
        <div className='hidden md:flex items-center'>
          <a class="mr-2 block hs-dark-mode group flex items-center text-gray-700 hover:text-purple-800 font-medium dark:text-white dark:hover:text-blue-500" href="#" target='_blank'>
            ...
            <p className='font-semibold text-base ml-1'>souza.jr91@gmail.com</p>
          </a>
          <a class=" mr-2 block hs-dark-mode group flex items-center text-gray-700 hover:text-purple-800 font-medium dark:text-white dark:hover:text-blue-500" href="#" target='_blank'>
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='font-semibold text-base ml-2'>(51) 9 9734-4246</p>
          </a>
        </div>
	...
	c2.472-6.151,4.404-12.57,5.692-19.229C292.095,211.143,216.738,199.457,165.515,201.127z"/>
          ...
          <div className='flex'>
            <a class=" mr-2 block hs-dark-mode group flex items-center text-purple-800 hover:text-violet-950 font-medium dark:text-white dark:hover:text-blue-500" href="#" target='_blank'>
      ...
      <nav class=" relative max-w-screen-xl w-full bg-white border border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700" aria-label="Global">
        ...
        <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
          <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
            <a className="font-semibold text-purple-800 md:py-6 dark:text-blue-500" href="#" aria-current="page">Sobre mim</a>
            <AnchorLink className="font-semibold text-gray-500 hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="#skills">Skills</AnchorLink>
            <AnchorLink className="font-semibold text-gray-500 hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="#projetos">Projetos</AnchorLink>
            <AnchorLink className="font-semibold text-gray-500 hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="#contato">Contato</AnchorLink>
          </div>
        </div>
      </nav>
    </header>
