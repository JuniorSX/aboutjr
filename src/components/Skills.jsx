...
import imgHtml from '../img/svg/html.svg';
import imgIllustrator from '../img/svg/illustrator.svg';
import imgJavascript from '../img/svg/javascript.svg';
import imgJest from '../img/svg/jest.svg';
import imgMySql from '../img/svg/mysql.svg';
import imgNode from '../img/svg/node.svg';
import imgPhotoshop from '../img/svg/photoshop.svg';
import imgReact from '../img/svg/react.svg';
import imgRedux from '../img/svg/redux.svg';
import imgTailwind from '../img/svg/tailwind.svg';
import imgTypescript from '../img/svg/typescript.svg';
import imgVite from '../img/svg/vite.svg';
import imgVue from '../img/svg/vue.svg';
  ...
  return (
    <>
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id='skills'>
        ...
        <div class="lg:w-1/2 mx-auto text-center mb-12">
          <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Principais Competências Técnicas</h2>
      ...
      <div class="lg:w-1/2 mx-auto text-center mb-6">
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-6 lg:gap-12">
          <div class="space-y-6 lg:space-y-10">
            ...
            <div class="flex">
              <svg class="flex-shrink-0 mt-2 h-8 w-8 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 36 36">
              ...
              <div class="ml-5 sm:ml-8">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                  Transmito ideias com clareza, tanto para a equipe técnica quanto para partes não técnicas.
                </p>
              </div>
            </div>

            <div class="flex">
              <svg class="flex-shrink-0 mt-2 h-8 w-8 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 1024 1024">
              ...
              <div class="ml-5 sm:ml-8">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                  Trabalho em equipe, compartilho conhecimento e integro perspectivas para resultados conjuntos.
                </p>
              </div>
            </div>
          ...
          <div class="space-y-6 lg:space-y-10">
            ...
            <div class="flex">
              <svg class="flex-shrink-0 mt-2 h-8 w-8 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 203.769 203.769">
		...
		C64.975,156.544,43.546,132.35,43.546,103.243z"/>
              ...
              <div class="ml-5 sm:ml-8">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                  Aprendo rapidamente novas tecnologias e me ajusto a diferentes projetos e equipes.
                </p>
              </div>
            </div>

            <div class="flex">
              <svg class="flex-shrink-0 mt-2 h-8 w-8 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 32 32">
              ...
              <div class="ml-5 sm:ml-8">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                  Analiso informações e tomo decisões fundamentadas para melhorar soluções.
                </p>
              </div>
            </div>
            ...
            <div class="flex">
              ...
              <div class="ml-5 sm:ml-8">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                  Coloco o usuário no centro do desenvolvimento, priorizando experiências intuitivas e funcionais.
                </p>
              </div>
            </div>
          </div>
